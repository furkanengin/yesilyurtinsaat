                    ...
                    <div className="row">
                        <div className="col-xl-3">
                            <div className="tp-about-title-box">
                                <span className="tp-section-subtitle pre tp_fade_anim">BİZ KİMİZ?</span>
                            </div>
                        </div>
                        ...
                        <div className="col-xl-9">
                            <div className="tp-about-wrap">
                                <div className="tp-about-text tp_fade_anim">
                                    <p>
                                        YEŞİLYURT İnşaat kurulduğu günden bu yana inşaat sektöründe yeni uygulamalara öncülük ederek; talep yaratan, çalışma alanlarını geliştirebilmeyi ve yönlendirebilmeyi hedefleyen bir marka oldu.
                                    </p>
                                </div>
                                <div className="row">
                                        ...
                                        <div className="tp-about-funcact-wrap">
                                            <div className="tp-about-avater-info">
                                                ...
                                                <div className="tp_text_anim">
                                                    <p>Kendisine bağlı yüzlerce alt sektöre talep yaratan ve ekonominin itici gücü konumunda olan inşaat sektörünün öneminin bilinciyle, YEŞİLYURT İnşaat her geçen yıl tecrübesini büyütürken iş kalitesini artırmayı hedeflemiştir.</p>
                                                </div>
                                            </div>
                                            {/* counter area */}
                                            <HomeMainCounter />
