      ...
      <div className="container-fluid p-0">
        <div className="row gx-0">
          <div className="col-12">
            <div className="tp-service-title-box">
              <span className="tp-section-subtitle pre">DEVAM EDEN PROJELERİMİZ</span>
            </div>
          </div>
        </div>
        <div className="tp-service-pin">
          ...
          <div className="text-center mt-5">
              <Link href="/projeler" className="tp-btn-black btn-red-bg">
    <span className="tp-btn-black-filter-blur">
      <ButtonBlurFilter filterId="buttonFilterAll" />
    </span>
                  <span
                      className="tp-btn-black-filter d-inline-flex align-items-center"
                      style={{ filter: `url(#buttonFilterAll)` }}
                  >
      <span className="tp-btn-black-text">Tüm Projeleri Gör</span>
