                    ...
                    <div className="row align-items-center">
                        <div className="col-xl-4 col-lg-4">
                            <div className="tp-footer-widget tp-footer-col-1 pb-40 tp_fade_anim" data-delay=".3">
                                <h4 className="tp-footer-widget-title">Birlikte <br /> inşa edelim.</h4>
                                {/* footer social icons */}
                        ...
                        <div className="col-xl-5 col-lg-4 col-md-6">
                            <div className={`tp-footer-widget ${quikLinkCls} tp-footer-col-2 pb-40 tp_fade_anim`} data-delay=".5">
                                <h4 className="tp-footer-widget-title-sm pre mb-25">Hızlı Ulaşın</h4>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            <div className="tp-footer-widget tp-footer-col-3 pb-40 mb-30 tp_fade_anim" data-delay=".7">
                                <h4 className="tp-footer-widget-title-sm pre mb-20">İletişim</h4>
                                <div className="tp-footer-widget-info">
                                    <Link href="mailto:agntixs@studio.com"> info@yesilyurtinsaat.com</Link>
                                    <Link href="tel:+905308791775">+90 530 879 17 75</Link>
                                </div>
                                <div className="tp-footer-widget-info">
                                    <Link href="https://maps.app.goo.gl/RME7go4X4Q2ZimHVA" target="_blank">Saltuklu Mah. Şehit Onbaşı Ömer Budak Cad.<br />
                                        No:23 B Aziziye Erzurum</Link>
                                </div>
                            </div>
                        </div>
                    </div>
