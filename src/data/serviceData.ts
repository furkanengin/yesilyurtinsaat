...
const servicesData: servicesDT[] = [
    //Home main services data start
    {
        ...
        title: "ARVEN SİTESİ",
        image: service1,
        description: "Arven Sitesi, Erzurum’da inşa edilen modern konut projesidir. Yeşilyurt İnşaat güvencesiyle hayata geçirilen proje; kalite, dayanıklılık ve estetiği bir araya getirir.",
    ...
    },
    {
        ...
        image: service2,
        description: "Erzurum’da yükselen Maya Apartmanı, Yeşilyurt İnşaat güvencesiyle inşa edilen modern konut projesidir. Kalite, dayanıklılık ve konforu bir araya getiren proje; yeni nesil yaşam standartlarını şehre kazandırıyor.",
    ...
    },
    {
        ...
        title: "AZTEK VİLLA",
        image: service3,
        description: "Erzurum’da Yeşilyurt İnşaat tarafından inşa edilen Aztek Villa, modern tasarım anlayışı ve yüksek kaliteli yapısıyla dikkat çekiyor. Konfor, güvenlik ve estetiği bir arada sunan villa projesi, ayrıcalıklı bir yaşamın kapılarını aralıyor.",
        categories: ["AZİZİYE / ERZURUM"],
        link: "/service-details-light",
    },
    {
