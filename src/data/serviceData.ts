...
const servicesData: servicesDT[] = [
    ...
    {
        id: 1,
        title: "MAYA APARTMANI",
        image: service1,
        description: "Erzurum’da yükselen Maya Apartmanı, 70 adet 1+1 daire ve 4 adet ticari iş yerinden oluşan, Yeşilyurt İnşaat güvencesiyle inşa edilen modern konut projesidir. Kalite, dayanıklılık ve konforu bir araya getiren proje; yeni nesil yaşam standartlarını şehre kazandırıyor.\n",
    ...
    },
    {
        ...
        title: "VİLLA TROYA",
        image: service2,
        description: "Erzurum’da Yeşilyurt İnşaat tarafından inşa edilen Villa Troya projesi, 6 adet villadan oluşan, modern tasarım anlayışı ve yüksek kaliteli yapısıyla dikkat çekiyor. Konfor, güvenlik ve estetiği bir arada sunan villa projesi, ayrıcalıklı bir yaşamın kapılarını aralıyor.",
        categories: ["YAKUTİYE/ Erzurum"],
        link: "/service-details-light",
    },
    {
        id: 3,
        title: "AZTEK APARTMANI",
        image: service3,
        description: "Erzurum’da Yeşilyurt İnşaat tarafından inşa edilen Aztek Apartmanı, 48 adet 1+1 daire ve 6 ticari iş yerinden oluşan ,modern tasarım anlayışı ve yüksek kaliteli yapısıyla dikkat çekiyor. Konfor, güvenlik ve estetiği bir arada sunan proje, ayrıcalıklı bir yaşamın kapılarını aralıyor.",
        categories: ["AZİZİYE / ERZURUM"],
        link: "/service-details-light",
    },
    {
    ...
    {
        id: 5,
        title: "YEŞİLYURT APARTMANI",
        image: service5,
        description: "Erzurum’da Yeşilyurt İnşaat tarafından inşa edilen Göktürk Apartmanı, 12 adet 1+1 daireden oluşan, modern tasarım anlayışı ve yüksek kaliteli yapısıyla dikkat çekiyor. Konfor, güvenlik ve estetiği bir arada sunan proje, ayrıcalıklı bir yaşamın kapılarını aralıyor.",
        link: "/service-details-light",
    },
    {
        id: 6,
